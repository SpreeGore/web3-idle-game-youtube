...
import { BUSINESSES_CONTRACT_ADDRESS, STAKING_CONTRACT_ADDRESSERC721, WORKER_CONTRACT_ADDRESS } from "../constants/contracts";
...
export default function NFTCard({ nft }: Props) {
    ...
    const { contract: stakingContract } = useContract(STAKING_CONTRACT_ADDRESSERC721);
    ...
    const handleClaim = async () => {
        ...
        try {
            await businessesContract?.erc721.claim( 1);
